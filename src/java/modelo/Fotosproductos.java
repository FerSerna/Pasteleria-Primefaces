...
@NamedQueries({
    ...
    , @NamedQuery(name = "Fotosproductos.fotosProductosActivas", query = "SELECT f FROM Fotosproductos f WHERE f.status = 1")
    , @NamedQuery(name = "Fotosproductos.fotosProductosEliminadas", query = "SELECT f FROM Fotosproductos f WHERE f.status = 0")
